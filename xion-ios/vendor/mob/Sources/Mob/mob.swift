...
public protocol ClientProtocol: AnyObject, Sendable {
     ...
     */
    func executeContract(contractAddress: String, msg: Data, funds: [Coin], granter: String?, feeGranter: String?, memo: String?, gasLimit: UInt64?) throws  -> TxResponse
...
open func attachSigner(signer: RustSigner)throws   {try rustCallWithError(FfiConverterTypeMobError_lift) {
     ...
     * If `fee_granter` is set, the fee granter pays gas.
     */
open func executeContract(contractAddress: String, msg: Data, funds: [Coin], granter: String?, feeGranter: String?, memo: String?, gasLimit: UInt64?)throws  -> TxResponse  {
...
open func post(url: String, body: Data)throws  -> Data  {
     ...
     * Used for LCD/REST API queries (e.g., account info).
     */
open func get(url: String)throws  -> Data  {
    return try  FfiConverterData.lift(try rustCallWithError(FfiConverterTypeTransportError_lift) {
    uniffi_mob_fn_method_httptransport_get(
            self.uniffiCloneHandle(),
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_mob_checksum_method_client_execute_contract() != 49361) {
        return InitializationResult.apiChecksumMismatch
    }
    ...
    if (uniffi_mob_checksum_method_httptransport_get() != 50031) {
        return InitializationResult.apiChecksumMismatch
    }
